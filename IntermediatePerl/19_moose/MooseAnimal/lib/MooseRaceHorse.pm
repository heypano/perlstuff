...
MooseRaceHorse - The great new MooseRaceHorse!
...
has 'sound' => ( is => 'ro', default => 'nEEEEIiigh' );
has 'color' => ( is => 'rw', default => 'gold' );
has 'anxiety' => (is => 'rw', default => 1);
=head2 function2
